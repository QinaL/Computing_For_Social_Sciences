...
This data is obtained from `springer_API.Rmd.` It contains the top 20 countries with the most published articles in the academic journal Springer Nature from the years 1970 to 2022, along with the count of published articles and rank for each country. 

```{r import_df, echo = F}
countries_df <- read_csv("springer_top_countries.csv")
head(countries_df)
```
## The Analysis: What are the countries that have the highest count of published articles in Springer Nature?

#### How Often Has a Country Been in the Top 10 Countries with the Most Published Articles in Springer Nature?
